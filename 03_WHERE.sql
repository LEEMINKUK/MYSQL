...
-- 3) OR 연산자와 함께 WHERE 절 사용. ORDER BY 도 함께 쓸수 있다.
 SELECT
        MENU_NAME,
        MENU_PRICE,
        CATEGORY_CODE,
...
SELECT
       ...
       CATEGORY_CODE
  FROM TBL_MENU
 WHERE MENU_PRICE BETWEEN 10000 AND 25000 -- 위와 결과값이 같다.
ORDER BY MENU_PRICE;
...
ORDER BY CATEGORY_CODE;
 ...
 SELECT
        ...
        CATEGORY_CODE
  FROM TBL_MENU
 WHERE CATEGORY_CODE IN (4,5,6) -- 위와 결과값이 같다.
ORDER BY CATEGORY_CODE;
